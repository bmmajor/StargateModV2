...
import com.bmmajor20.stargatemod.items.BlackHoleParticles;
import com.bmmajor20.stargatemod.items.Singularity;
import com.bmmajor20.stargatemod.items.WhiteHoleParticles;
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < tileInvSize) {
                ...
                } else if (stack.getItem() == Registration.BLACK_HOLE_PARTICLES.get() || stack.getItem()  == Registration.WHITE_HOLE_PARTICLES.get()) {
