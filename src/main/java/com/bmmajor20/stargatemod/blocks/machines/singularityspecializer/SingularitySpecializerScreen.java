...
public class SingularitySpecializerScreen extends ContainerScreen<SingularitySpecializerContainer> {

    private ResourceLocation GUI = new ResourceLocation(StargateMod.MODID, "textures/gui/singularity_specializer_gui.png");

    public SingularitySpecializerScreen(SingularitySpecializerContainer container, PlayerInventory inv, ITextComponent name) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String titleGUI = "Singularity Specializer";
