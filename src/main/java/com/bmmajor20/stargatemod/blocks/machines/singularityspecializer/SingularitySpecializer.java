...
public class SingularitySpecializer extends Block {

    public SingularitySpecializer() {
            ...
            if (tileEntity instanceof SingularitySpecializerTile) {
                INamedContainerProvider containerProvider = new INamedContainerProvider() {
                    ...
                    public ITextComponent getDisplayName() {
                        return new TranslationTextComponent("screen.stargatemod.singularity_specializer");
                    }
