...
import static com.bmmajor20.stargatemod.setup.Registration.FIRSTBLOCK;
import static com.bmmajor20.stargatemod.setup.Registration.FIRSTBLOCK_CONTAINER;
...
public class FirstBlockContainer extends Container {
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, FIRSTBLOCK.get());
    }
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < tileInvSize) {
                ...
                } else if (stack.getItem() == Registration.ZERO_POINT_MODULE.get()) {
