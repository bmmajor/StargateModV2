        ...
        private static final Block[][][] observatoryLayout = {
                {
                        ...
                        {AIR,                           AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR},
                        {AIR,                           AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            AIR},
                        {AIR,                           AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            AIR},
                        {AIR,                           AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            AIR},
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_HATCH_CONTROL.get(),OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                        {AIR,                           AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR},
                        {AIR,                           AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR},
                        {AIR,                           AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR},
                },
                {
                        {AIR,                           AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR},
                        {AIR,                           AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            OBSERVATORY_HATCH_BLOCK.get(),  OBSERVATORY_HATCH_BLOCK.get(),  AIR,                            AIR},
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                        {AIR,                           AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR},
                ...
                },
                {
                        ...
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                        {OBSERVATORY_DOME_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get()},
                        {OBSERVATORY_DOME_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get()},
                        {OBSERVATORY_DOME_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get()},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                ...
                },
                {
                        ...
                        {OBSERVATORY_DOME_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get()},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                },
                {
                        {AIR,                           AIR,                            OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR},
                        {AIR,                           OBSERVATORY_DOME_BLOCK.get(),   AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_DOME_BLOCK.get(),   AIR},
                ...
                {
                        {AIR,                           OBSERVATORY_WALL_BLOCK.get(),   OBSERVATORY_WALL_BLOCK.get(),   OBSERVATORY_WALL_BLOCK.get(),   OBSERVATORY_WALL_BLOCK.get(),   OBSERVATORY_WALL_BLOCK.get(),   OBSERVATORY_WALL_BLOCK.get(),   OBSERVATORY_WALL_BLOCK.get(),   AIR},
                        {OBSERVATORY_WALL_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_WALL_BLOCK.get()},
                        {OBSERVATORY_WALL_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_WALL_BLOCK.get()},
                        {OBSERVATORY_WALL_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_WALL_BLOCK.get()},
                        {OBSERVATORY_WALL_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_WALL_BLOCK.get()},
                        {OBSERVATORY_WALL_BLOCK.get(),  AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            AIR,                            OBSERVATORY_WALL_BLOCK.get()},
                ...
                {
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_MAIN_CONTROL.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
                        {OBSERVATORY_FLOOR_BLOCK.get(), OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get(),  OBSERVATORY_FLOOR_BLOCK.get()},
